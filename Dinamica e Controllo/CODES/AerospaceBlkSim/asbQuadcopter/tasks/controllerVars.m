...
Controller.motorsThrustPerMotorMax = Vehicle.Motor.maxLimit*Vehicle.Rotor.commandToThrust; %Vehicle.Motor.maxLimit*Vehicle.Motor.commandToW2Gain*Vehicle.Rotor.Ct*rho*Vehicle.Rotor.area*Vehicle.Rotor.radius^2;
