...
// POS  CONTROLLER
const double Kp[3] = {0.25,0.25,0.5};
...
const double ang_rates_PD[2] = {500,20};
...
//
//variable for velocity PID
//_last should be GLOBAL variable in simulink
double P[3];
double I[3];
double I_last[3];
double D[3];
...
double vel_fb_last[3]={0,0,0}; //velocità passata di fb per azione derivativa
double acc_des[3];
...
//varible share with SIMULINK

double dt; //differential derivative and integral
double pos_err[3];
double vel_fb[3]; 
double q_fb[4];
double omega_fb[3];
