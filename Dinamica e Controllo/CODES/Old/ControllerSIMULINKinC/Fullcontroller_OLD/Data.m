...
Drone.J = diag([ 3.5 3.5 5 ]);                                             % Inertia Matrix of the drone [kg*m^2]
...
% Attitude Controller
Controllers.Kp_roll = 500;
Controllers.Kp_pitch = 500;
Controllers.Kp_yaw = 500;
Controllers.Kd_roll = 100;
Controllers.Kd_pitch = 100;
Controllers.Kd_yaw = 100;
